...
export async function getPage(
    ...
    params.append(
        "listarDetalleInfraccionRAAForm:dt_pagination",
        "true"
    );

    params.append(
        "listarDetalleInfraccionRAAForm:dt_first",
        first.toString()
    );
    ...
    params.append(
        "listarDetalleInfraccionRAAForm:dt_skipChildren",
        "true"
    );

    params.append(
        "listarDetalleInfraccionRAAForm:dt_encodeFeature",
        "true"
    );
